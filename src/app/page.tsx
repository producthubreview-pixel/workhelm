...
const plans = [
  ...
  { name: "Starter", price: "$29", subtitle: "14-day free trial", features: ["2 users", "Up to 250 leads", "Full pipeline & follow-ups", "Message templates", "Estimate tracking"], cta: "Try Free", href: "/signup", featured: false },
  { name: "Pro", price: "$59", subtitle: "14-day free trial", features: ["5 users", "Unlimited leads", "Everything in Starter", "Priority support"], cta: "Try Free", href: "/signup", featured: true },
];
