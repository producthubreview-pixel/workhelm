...
export function LeadsUsageBanner() {
  ...
  // Don't show anything while loading or for non-FREE users
  if (loading || !data || data.plan !== "FREE") return null;
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className={`font-semibold text-sm ${textColor}`}>
              {isAtLimit
                ...
                : isNearLimit
                  ? `${limit - count} lead${limit - count === 1 ? "" : "s"} remaining — upgrade to Starter for 250 leads`
                  : `You've used ${count} of ${limit} leads`}
            </p>
          </div>
